...
function Sidebar({view,dispatch,onLogout,onAlterarSenha,profile}){
  ...
  return(
    <>
      ...
      <div style={{display:"flex",minHeight:"100vh",background:"var(--bg-base)",fontFamily:"var(--font)"}}>
        <Sidebar view={view} dispatch={auditedDispatch} onLogout={signOut} onAlterarSenha={()=>setShowAlterarSenha(true)} profile={profile}/>
